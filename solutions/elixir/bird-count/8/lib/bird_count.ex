defmodule BirdCount do
  ...
  defp total_acc([h | t], acc), do: total_acc(t, acc + h)

  @spec busy_days_acc(bird_list(), non_neg_integer()) :: non_neg_integer()
  defp busy_days_acc([], acc), do: acc
  defp busy_days_acc([h | t], acc) when h >= @busy_day_threshold, do: busy_days_acc(t, acc + 1)
  defp busy_days_acc([_ | t], acc), do: busy_days_acc(t, acc)
end
