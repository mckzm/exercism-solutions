 ...
 */
export function getSecondCard([, secondCard] = deck) {
    return secondCard;
}
 ...
 */
export function swapTwoCards([firstCard, secondCard] = deck) {
 ...
 */
export function shiftThreeCardsAround([firstCard, secondCard, thirdCard] = deck) {
 ...
 *
 * constraint: 🚨 Do NOT use piles.chosen or piles.disregarded.
 *
 */
export function pickNamedPile({ chosen } = piles) {
    return chosen;
}
 ...
 *  🚨 Do NOT touch [the return statement] or Elyse will accidentally reveal the trick.
 */
