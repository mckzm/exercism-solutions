...
(defn clean
  "TODO: add docstring"
  [s]
  (filter-out-lower-case-greek-letters (keep-letters-and-underscores-only (convert-kebab-case-to-camelCase (convert-ctrl-char-to-CTRL (convert-spaces-to-underscores s))))))
