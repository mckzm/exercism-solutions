defmodule Username do
  ...
  defp sanitize_aux([h | t], sanitized) when h in ?a..?z or h == ?_,
    do: sanitize_aux(t, [h | sanitized])

  defp sanitize_aux([h | t], sanitized) when h in [?ß, ?ä, ?ö, ?ü],
    do: sanitize_aux(@transliterations[h] ++ t, sanitized)
