...
export class ProgramWindow {
    ...
    move(newPosition) {
        const newX = this.#clampParam(newPosition.x, 0, this.screenSize.width, this.size.width);
        const newY = this.#clampParam(newPosition.y, 0, this.screenSize.height, this.size.height);
