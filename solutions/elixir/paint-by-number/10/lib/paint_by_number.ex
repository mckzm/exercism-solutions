defmodule PaintByNumber do
  ...
  def get_first_pixel(picture, color_count) do
    {first_pixel, _rest} = split_on_first_pixel(picture, color_count)
    first_pixel
  end
  ...
  def drop_first_pixel(picture, color_count) do
    {_first_pixel, rest} = split_on_first_pixel(picture, color_count)
    rest
  end

  @spec split_on_first_pixel(bitstring(), integer()) :: {integer(), bitstring()}
  defp split_on_first_pixel(picture, color_count) do
    width = palette_bit_size(color_count)
